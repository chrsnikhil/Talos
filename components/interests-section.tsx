...
const channels = [
  { icon: FaEthereum, title: "Web3 & DeFi", description: "Exploring decentralized protocols, smart contracts, and the future of finance on-chain.", accent: "var(--t-navy)", tag: "ON-CHAIN" },
  { icon: FaCode, title: "Open Source", description: "Contributing to and building tools that empower the developer community worldwide.", accent: "var(--t-navy)", tag: "COMMIT" },
  { icon: FaVideo, title: "Content Creation", description: "Editing dynamic recaps and promo videos that capture the energy of hackathons and tech events.", accent: "var(--t-navy)", tag: "ON AIR" },
  { icon: FaDumbbell, title: "Fitness", description: "Discipline in the gym fuels clarity in code. Consistent training transformed my lifestyle and focus.", accent: "var(--t-red)", tag: "LIVE" },
  { icon: FaGamepad, title: "Gaming", description: "Competitive gaming sharpens strategy and reaction time — skills that translate directly to problem-solving.", accent: "var(--t-navy)", tag: "PLAYER 1" },
  { icon: FaBookOpen, title: "Continuous Learning", description: "Always picking up new frameworks, languages, and paradigms to stay ahead of the curve.", accent: "var(--t-navy)", tag: "REC" },
]
        ...
        <div className="max-w-7xl mx-auto">
          <div className="scroll-reveal mb-12 text-center">
            ...
            <p className="text-base md:text-lg font-medium leading-relaxed max-w-2xl mx-auto" style={{ color: "var(--t-text-muted)" }}>
              Change the channel — six things that keep me sharp off the court.
            </p>
          </div>
              ...
              >
                ...
                {staticOn && <div aria-hidden="true" className="crt-static absolute inset-0 z-40 pointer-events-none" />}
                  ...
                  <div className="flex items-center gap-2 mt-3 px-1">
                    <span className="vl-display text-sm md:text-base" style={{ color: "var(--t-paper)" }}>CN<span className="text-[8px] align-super">®</span></span>
                    <span className="text-[7px] font-extrabold uppercase tracking-[0.28em] hidden sm:inline" style={{ color: "rgba(251,249,244,0.32)", fontFamily: "var(--t-font-mono)" }}>Trinitron · 26&quot;</span>
                ...
                <div className="flex flex-col items-center justify-center gap-3.5 shrink-0 pl-3" style={{ borderLeft: "2px solid rgba(251,249,244,0.12)" }}>
                  <span className="text-[7px] font-extrabold uppercase tracking-[0.2em]" style={{ color: "rgba(251,249,244,0.4)", fontFamily: "var(--t-font-mono)" }}>VHF</span>
                  <Knob />
                  <Knob />
            ...
            <div className="tv-remote-stage relative -mt-2 md:-mt-3 w-full flex justify-center">
              ...
              >
                ...
                <div className="flex items-center justify-between mb-5">
                  ...
                  <span className="text-[9px] font-extrabold uppercase tracking-[0.3em]" style={{ color: "rgba(251,249,244,0.5)", fontFamily: "var(--t-font-mono)" }}>CN-RC1</span>
                  <button
                    onClick={togglePower}
                    aria-label="Power"
                ...
                <div className="flex flex-col items-center gap-1.5">
                  ...
                  <span className="mt-1 text-[7px] font-extrabold uppercase tracking-[0.3em]" style={{ color: "rgba(251,249,244,0.3)", fontFamily: "var(--t-font-mono)" }}>Model CN-RC1 · IR</span>
                </div>
              </div>
