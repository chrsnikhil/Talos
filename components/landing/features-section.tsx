...
const features = [
  {
    ...
    description: "Icarus rebalances real USDC across Suilend and Scallop in a single programmable transaction block — redeem, swap, supply, all-or-nothing. No half-states, no stranded funds.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Two agents, zero trust",
    description: "Daedalus independently re-evaluates every Icarus decision and writes a tamper-proof CriticRating on-chain. Reputation is earned in public, not assumed.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Verifiable memory",
    description: "Every decision the swarm makes is written to Walrus — the rationale, the inputs, the outcome. An audit trail anyone can replay, owned by no one.",
    visual: "collab",
  },
  {
    number: "04",
    title: "On-chain leash",
    description: "A Move policy object caps the budget, allowlists protocols, sets an expiry, and honors owner revocation. A compromised agent physically cannot exceed its bounds — safety by enforcement, not trust.",
    visual: "security",
  },
];
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            The chain is the leash.
            <br />
            <span className="text-muted-foreground">Not your trust.</span>
          </h2>
        </div>
