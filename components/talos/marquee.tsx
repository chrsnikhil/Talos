...
const skills = [
  ...
  { label: "Move", icon: SiSolidity },
  { label: "PTBs", icon: SiTypescript },
  { label: "Walrus", icon: SiNextdotjs },
  { label: "Suilend", icon: SiBitcoin },
  { label: "Scallop", icon: SiEthereum },
  { label: "DeepBook", icon: FaLaptopCode },
  { label: "USDC", icon: FaEdit },
  { label: "On-chain reputation", icon: FaVideo },
]
